...
//            this.parse(comment + "\n{}").getComments().getData(xjs.comments.CommentType.HEADER));
//    }
//
//    @ParameterizedTest
...
//        assertEquals(comment,
//            this.parse("{}\n" + comment).getComments().getData(xjs.comments.CommentType.FOOTER));
//    }
//
//    @ParameterizedTest
...
//        assertEquals(comment,
//            this.parse("{}" +  comment).getComments().getData(xjs.comments.CommentType.EOL));
//    }
//
//    @ParameterizedTest
//    @CsvSource({"/*header*/", "#header", "//header"})
...
//        assertEquals(comment,
//            this.parse(comment + "\nk:v").asObject().get(0).getComments().getData(xjs.comments.CommentType.HEADER));
//    }
//
//    @ParameterizedTest
...
//        assertEquals(comment + "\n",
//            this.parse("k:\n" + comment + "\nv").asObject().get(0).getComments().getData(xjs.comments.CommentType.VALUE));
//    }
//
//    @ParameterizedTest
//    @CsvSource({"/*eol*/", "#eol", "//eol"})
...
//        assertEquals(comment,
//            this.parse("k:v" + comment).asObject().get(0).getComments().getData(xjs.comments.CommentType.EOL));
//    }
//
//    @ParameterizedTest
...
//        assertEquals(comment,
//            this.parse("{\n" + comment + "\n}").getComments().getData(xjs.comments.CommentType.INTERIOR));
//    }
//
//    @ParameterizedTest
...
//        assertEquals(comment + "\n",
//            this.parse("k1:v1\n" + comment + "\n\nk:v")
//                .asObject().get(1).getComments().getData(xjs.comments.CommentType.HEADER));
//    }
//
//    @Test
